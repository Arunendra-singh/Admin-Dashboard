...
export function useVirtualSample(): UseMutationResult<IGetCatalogEmailTemplateResponse, Error, string, unknown> {
    return useMutation({
        mutationKey: ["CreateEmailJson"],
        mutationFn: async (catelogGuid: string) => {
            return await new Promise((resolve, reject) => {
                CallApi({
                    url: `${MS_URL.CATALOG}api/Catalog/CreateEmailJson/${catelogGuid}/true`,
                    type: "GET",
                    isAsync: false,
