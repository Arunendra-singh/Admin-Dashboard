...
export function useSampleOrderNew(): UseMutationResult<RequestQuoteData, Error, IFilterData, unknown> {
    return useMutation({
        ...
        mutationFn: async (postData) =>
            await new Promise((resolve, reject) => {
                const pagesize = 10;
                CallApi({
                    url: `${MS_URL.ORDER}api/order/OrderSampleReportAPI/${pagesize}`,
                    type: "POST",
