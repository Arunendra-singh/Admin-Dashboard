...
export function useGetWebsiteSpecificCountries(cacheTime: number = 5 * 60 * 1000): UseQueryResult<IGetAllCountryResponse, Error> {
    return useQuery({
        queryKey: ["getCountry", QUERY_KEY_VERSION],
        queryFn: async () => {
            return await new Promise((resolve, reject) => {
                CallApi({
                    url: `${MS_URL.CONFIGURATION}api/Countries/GetWebsiteSpecificCountriesAPI`,
                    type: "GET",
