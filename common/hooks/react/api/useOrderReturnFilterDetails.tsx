...
export function useOrderReturnFilterDetails(): UseMutationResult<IUserOrderFilterDetailsResponse, Error, IUserOrderFilterDetailsPorps, unknown> {
    return useMutation({
        mutationKey: ["OrderReturnReportFilterDetailsAPI"],
        mutationFn: async (productBasketVM: IUserOrderFilterDetailsPorps) =>
            await new Promise((resolve, reject) => {
                CallApi({
                    url: `${MS_URL.ORDER}api/order/OrderReturnReportFilterDetailsAPI`,
                    type: "POST",
