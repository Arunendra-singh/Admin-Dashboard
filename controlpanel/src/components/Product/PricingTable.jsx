...
const PricingTable = () => {
    ...
    const handleDateChange = (date) => {
        setFormData({ ...formData, strikePriceExpiryDate: date });
    };
                ...
                <div className="details">
                        ...
                        <div className="col-md-2">
                            <div className="form-group">
                                <p className="default-tag">
                                    Pricing Name <span className="icon-alert-circle" />
                                </p>
                                <input aria-label="pricingName" type="text" name="pricingName" value={formData.pricingName} onChange={handleInputChange} />
                            </div>
                        </div>
                        <div className="col-md-2 offset-1">
                            <div className="input-group setasdefault">
                                <label htmlFor="setdefault">
                                    ...
                                    <span className="checksetdefault">New Product</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-2">
                            <div className="form-group">
                                <p className="default-tag">
                                    Notes <span className="icon-alert-circle" />
                                </p>
                                <input aria-label="notes" type="text" name="notes" value={formData?.notes} onChange={handleInputChange} />
                            </div>
                        </div>
                        <div className="col-md-2 offset-1">
                            <div className="input-group setasdefault">
                                <label htmlFor="RegularPrice">
                                    <input type="checkbox" name="RegularPrice" label="RegularPrice" autoComplete="off" id="RegularPrice" value="" />
                                    <span className="checksetdefault">Regular Price</span>
                                </label>
                            </div>
                        </div>
                        <div className="col-md-2">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2 offset-1">
                            <div className="form-group">
                                <p className="default-tag">
                                    Production Time <span className="icon-alert-circle" />
                                </p>
                                <input label="CallforPrice" type="number" name="productionTime" value={formData?.productionTime} onChange={handleInputChange} placeholder="-- days" />
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-2">
                            <div className="form-group">
                                <p className="default-tag">
                                    Strike Price Expiry Date <span className="icon-alert-circle" />
                                </p>
                                <input className="remove-before" aria-label="date" type="date" selected={formData?.strikePriceExpiryDate} onChange={handleDateChange} />
                            </div>
                        </div>
                        <div className="col-md-2 offset-1">
                            <div className="form-group">
                                <p className="default-tag">
                                    Additional Notes <span className="icon-alert-circle" />
                                </p>
                                <input label="additionalNotes" type="text" name="additionalNotes" value={formData?.additionalNotes} onChange={handleInputChange} />
                            </div>
                        </div>
                    </div>
                </div>
