...
const ButtonWithIcon = ({ link, type, name, display, iconName, elemId, style = "" }) => {
    ...
    return (
        <>
            <button id={elemId} className={`${displayClasses} ${styles.btn}`} onClick={onClickHandler} type={type}>
